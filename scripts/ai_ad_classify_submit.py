...
- 네이버 지식iN/카페 검색 스니펫은 원 질문 뒤에 기존 답변/댓글이 이어붙을 수 있음.
  제목·앞부분이 자연 질문이어도 뒤쪽에 "저도 ... 효과", "OO한의원 추천",
  "상담 한번 받아보세요", "네이버에서 검색", "진료 예약/위치/전화",
  "비용 부담 없이", "할인이벤트/무제한/패키지"가 있으면 자연_질문이 아니라
  광고 또는 광고성_후기톤으로 분류.
